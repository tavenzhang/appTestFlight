  ...
  render() {
    ...
    return (
      <View {...other} style={[mainStyles.container, style]} onLayout={this._measureContainer}>
        <View
          style={[{backgroundColor: maximumTrackTintColor,width:style.width}, mainStyles.track,trackStyle]}
          onLayout={this._measureTrack} />
        <Animated.View style={[mainStyles.track,{width:style.width}, trackStyle, minimumTrackStyle]} />
        <Animated.View
