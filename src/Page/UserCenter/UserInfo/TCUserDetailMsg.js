        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.setItem}>
                    ...
                    <View style={{marginRight:10,height:40,width:40,borderRadius:20,borderWidth:TCLineW,borderColor:'rgba(0,0,0,0.3)',
                        backgroundColor:TCUSER_ICON_BGCOLOR,alignItems:'center',justifyContent:'center'}}>
                        <Text style={{fontSize:15,fontWeight:'bold',color:'white'}}>{JXHelper.getUserIconShowName(TCUSER_DATA.username)}</Text>
                    </View>
                </View>
                <View style={styles.setItem}>
