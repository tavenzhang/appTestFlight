...
import {Size, width, height, indexBgColor, listViewTxtColor, inputStyle, buttonStyle} from '../../resouce/theme'
                    ...
                    <View>
                        <View style={styles.inputItemStyle}>
                            <View style={styles.inputTitleTxt}>
                                <Text style={{color: listViewTxtColor.title, fontSize: Size.default}}>{'持 卡 人  '}</Text>
                            </View>
