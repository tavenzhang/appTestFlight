        ...
        return (
            <View style={styles.container}>
                ...
                <Dialog
                    ...
                    dialogTitle={'温馨提示'}
                    dialogContent={(Platform.OS == 'ios' ? '请先手动截屏保存二维码至相册再打开' : '将为您截屏并打开') + '微信，是否立即打开？'}
                    btnTxt={'打开'}
                    leftTxt={'取消'}
                />
            </View>
    ...
    getInfoView() {
        ...
        return (
            <View style={{marginTop: 15, marginLeft: 5}}>
                ...
                {this.getItemView('3.进入公众号后，点击下方"在线充值"按钮。', ASSET_Other.Other.pay.payStep.step1)}
                {this.getItemView('4.输入账号、金额，完成充值(账号是本平台的登录账号《我的->个人信息->用户名》)。', ASSET_Other.Other.pay.payStep.step2)}
            </View>
        )
    }
