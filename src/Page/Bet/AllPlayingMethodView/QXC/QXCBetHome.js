...
@observer
export default class TCQXCBetHome extends TCBaseBetHome {
    ...
    constructor(props){
        super({...props,gameName:'QXC',contentView:QXC_MainView,isMultyMethod:true})
    }
    ...
    showBetSettingModal() {
        ...
        if (this.SingletonDPS.getPlayTypeId() == 'DXDS_SUM') {
