        ...
        for (let i = 0; i < numberArray.length; i++) {
            if (this.props.dsStyle) {
                itemArr.push(<NumberView numberEvent={this.props.numberEvent} number={numberArray[i]} key={i}
                                         areaIndex={areaIndex} selectedEvent={(e) => this.buttonCall(e)} isNoNeedQDXDSQ={this.props.isNoNeedQDXDSQ}/>)
            } else {
                itemArr.push(<NumberView numberEvent={this.props.numberEvent} number={numberArray[i]} key={i}
                                         areaIndex={areaIndex} isNoNeedQDXDSQ={this.props.isNoNeedQDXDSQ}/>)
            }
        }
