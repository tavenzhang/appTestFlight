...
@observer
export default class TCK3BetHome extends TCBaseBetHome{
    static defaultProps = {
        cp_playMath: '和值',
        unit_price: 2,
    }
    ...
    constructor(props){
        super({...props,gameName:"K3",contentView:TCK3_MainView})
    }
  ...
  //   _panResponder = {}
    ...
    //         SingletonDPS.getMaxRebate(prizeSettings),
