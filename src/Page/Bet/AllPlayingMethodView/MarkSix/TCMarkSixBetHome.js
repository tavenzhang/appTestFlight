...
@observer
export default class TCMarkSixBetHome extends TCBaseBetHome {
    ...
    constructor(props){
        super({...props,gameName:"MarkSix",contentView:MarkSixMainView,isMultyMethod:true})
    }
    ...
    betSetEndingEvent(json) {
        ...
        // this.userPlayNumberEvent.str.alreadyAdd = this.SingletonDPS.getAddedAllUnits()
        this.pushToBetBill()
    }
