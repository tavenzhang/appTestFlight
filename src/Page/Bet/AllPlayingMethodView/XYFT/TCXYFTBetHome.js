...
export default class TCXYFTBetHome extends React.Component {
    ...
    //初始化玩法号码选择
    initialContentView() {
        return <TCXYFT_MainView ref='TCXYFT_MainView' numberEvent={this.userPlayNumberEvent} shakeEvent={()=>this.byShake()} gameUniqueId={this.props.gameUniqueId} defaultPlayType={myPlayMath}/>
    }
