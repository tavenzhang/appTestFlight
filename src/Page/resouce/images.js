...
export const common = {
    ...
    warn: require('./addon/other/warn.png'),
    close: require('./addon/other/close.png'),
    ...
    select: require('./addon/other/bank_select.png'),
    unSelect: require('./addon/other/bank_select2.png'),
...
export const home = {
    ...
    indexTransferPressed: require('./homeIcon/index_transfer_pressed.png'),
}
...
export const personal = {
    ...
    toolUpdate: require('./addon/userCenterIcon/tool_update.png'),
    toolAbout: require('./addon/userCenterIcon/tool_about.png'),
    toolFeedBack: require('./addon/userCenterIcon/feedback.png'),
    toolMusic: require('./addon/userCenterIcon/tool_music.png'),
    toolPassword: require('./addon/userCenterIcon/tools_password.png'),
    toolPassword2: require('./addon/userCenterIcon/tools_password2.png'),
    bankManager: require('./addon/userCenterIcon/bank_manage.png'),
    payRecord: require('./addon/userCenterIcon/pay_records.png'),
    withDraw: require('./addon/userCenterIcon/withdraw_withdraw.png'),
    username: require('./addon/userCenterIcon/user.png'),
    password: require('./addon/userCenterIcon/password.png'),
...
export const userPay = {
    ...
    wechat: require('./addon/other/wechat.png'),
    alipay: require('./addon/other/alipay.png'),
    bank: require('./addon/other/bank.png'),
    jdzf: require('./addon/other/jdzf.png'),
    userAlipayHelp01: require('./addon/other/alipay01.png'),
    userAlipayHelp02: require('./addon/other/alipay02.png'),
    userWechatPayHelper02: require('./addon/other/wechat02.png'),
    userAlipayHelp03: require('./addon/other/alipay03.png'),
    userWechatPayHelper03: require('./addon/other/wechat03.png'),
    userAlipayHelp04: require('./addon/other/alipay04.png'),
    userWechatPayHelper04: require('./addon/other/wechat04.png'),
    paidui01: common.select,
    paidui02: require('./addon/other/paidui22.png'),
    paidui03: require('./addon/other/win.png'),
    step1: require('../asset/pay_step/step_1.png'),
    step3: require('../asset/pay_step/step_3.png'),
    step4: require('../asset/pay_step/step_4.png'),
    step5: require('../asset/pay_step/step_5.png'),
    step6: require('../asset/pay_step/step_6.png'),
    step7: require('../asset/pay_step/step_7.png'),
    step8: require('../asset/pay_step/step_8.png'),
    step9: require('../asset/pay_step/step_9.png'),
    stepWx3: require('../asset/pay_step/wx_step_3.png'),
    stepWx4: require('../asset/pay_step/wx_step_4.png'),
...
export const betIcon = {
    bgPlace: require('./addon/other/bg_place.png'),
