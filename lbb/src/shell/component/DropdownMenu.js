...
export default class DropdownMenu extends PureComponent {
  ...
  static defaultProps = {
    tabSelectColor: '#1296db',
    tabUnSelectColor: '#8a8a8a',
    tabData: [],
    tabLabelSize: 16,
    contentHeight: 200,
    arrowImg: require('../images/ic_arrow_bottom_gray.png')
  };
  ...
  async _onTabSelect(index) {
    if (this.tabTop === 0) {
      ...
      this.tabTop = location.py + location.height;
    }
          ...
          <Modal
            ...
            <TouchableWithoutFeedback onPress={this.hide}>
              <View style={styles.modal}>
                <Animated.View
                    style={[styles.bg, {top: this.tabTop, opacity: this.state.opacityAnimated}]}/>
                <Animated.View style={{
                  position: 'absolute',
                  top: this.tabTop,
                  height: this.state.contentAnimated
                }}>
                  {/*content*/}
        ...
        <TouchableOpacity
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text style={[styles.tabTextStyle,
              {
                fontSize: this.props.tabLabelSize,
                color: this._computeSelectColor(index)
              }]}>{item}</Text>
    ...
    return (
        <Animated.Image
            ...
            style={{
              ...
              height: 20,
              marginLeft: 4,
              tintColor: this._computeSelectColor(index),
              transform: [{
