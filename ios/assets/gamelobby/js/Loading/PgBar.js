...
var PgBar = /** @class */ (function (_super) {
    ...
    PgBar.prototype.onLoadedBg = function () {
        ...
        //如果资源图片的大小与当前定义的大小不一致
        // var scx = this.conf.bg.rect.w/t.width;
        // var scy = this.conf.bg.rect.h/t.height;
        // this.bg.scale(scx,scy);
        //背景居中摆放
        // var sum_w = t.width - SCREEN_WIDTH;
        // var sum_h = t.height - SCREEN_HEIGHT;
        // this.bg.pos(-sum_w/2,-sum_h/2);
    };
    PgBar.prototype.onLoadedFront = function () {
        ...
        //如果资源图片的大小与当前定义的大小不一致
        // var scx = this.conf.front.rect.w/t.width;
        // var scy = this.conf.front.rect.h/t.height;
        // this.front.scale(scx,scy);
        // this.fullw = t.width * scx;
        // Debug.trace("this.fullw:"+this.fullw+" t.width:"+t.width+" scx:"+scx);
    };
