var Tools = /** @class */ (function () {
    ...
    */
    ...
    Tools.jump2game = function (url) {
        try {
            ...
            var jobj = {
                ...
                "httpUrl": confUrl ? confUrl.url.rooturl : "",
                "gameId": Common.gameId,
                "wsUrl": Common.wsUrl,
                "roomId": Common.roomId,
                "backUrl": confUrl ? ConfObjRead.getConfUrl().url.backlobby : ""
            };
            var b = new MyBase64();
    ...
    Tools.jump2module = function (url, type) {
        try {
            ...
            var jobj = {
                "token": Common.access_token,
                "httpUrl": ConfObjRead.getConfUrl().url.rooturl,
    ...
    */
    ...
    //新建一个多行文本框
    Tools.newText = function (str, width, //x:number,y:number,
    fontsize, color, align, valign, wordWrap) {
