...
var RoomPanel = /** @class */ (function (_super) {
    ...
    RoomPanel.prototype.requestData = function () {
        ...
        ConfObjRead.getConfUrl().url.lobbyurl +
            // Common.confObj.cmd.roomlist+
        ...
        // if( UIBg.obj )
        // {
        //     UIBg.obj.changeBg(this.conf.bigbg.src);
        // }
    };
    ...
    RoomPanel.prototype.responseRoomList = function (s, stat) {
        Debug.trace("response RoomList:" + stat);
        Debug.trace(s);
        if (stat == "complete") {
            //设置所有参数
            this.roomInfo = s;
