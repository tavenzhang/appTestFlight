...
var GirlManager = /** @class */ (function (_super) {
    ...
    GirlManager.prototype.refreshDrag = function (x, y) {
        ...
        // 当前对象的坐标
        var obj = this.getCurObj(this.cur_choose_id);
        //用差值加起来成为新坐标
        var newx = obj.x - sumx;
    ...
    //女孩弹出之后
    GirlManager.prototype.onGirlMoveOut = function (e) {
        Debug.trace("GirlManager.onGirlMoveOut");
        Debug.trace(e);
    };
    //女孩弹入之后
    GirlManager.prototype.onGirlMoveIn = function (e) {
        Debug.trace("GirlManager.onGirlMoveIn");
        Debug.trace(e);
    };
    ...
    GirlManager.prototype.onMouseEvent = function (e) {
        ...
        switch (e.type) {
            case Laya.Event.MOUSE_DOWN:
                //按下了，开始拖拽
                if (!this.bDrag) {
                    var obj_now = this.getCurObj(this.cur_choose_id);
                    if (obj_now) {
                        this.bDrag = true;
                        this.dragStartPos = {
                            "x": x,
