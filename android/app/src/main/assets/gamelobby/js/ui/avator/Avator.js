...
var Avator = /** @class */ (function (_super) {
    ...
    Avator.prototype.init = function (conf, caller, callback) {
        ...
        //请求用户信息
        this.requestUserInfo(ConfObjRead.getConfUrl().url.accounturl +
    ...
    Avator.prototype.responseUserInfo = function (s, stat) {
        ...
        if (stat == "complete") {
            ...
            // Debug.trace("lobbyurl:"+ConfObjRead.getConfUrl().url.lobbyurl);
            // Debug.trace("avatorget:"+ConfObjRead.getConfUrl().cmd.avatorget);
            //有了用户信息，还要通过一个新接口获得用户头像及昵称
            this.requestUserAvator(ConfObjRead.getConfUrl().url.lobbyurl +
    ...
    Avator.prototype.responseUserAvator = function (s, stat) {
