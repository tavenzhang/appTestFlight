...
var LoadingScene = /** @class */ (function (_super) {
    ...
    LoadingScene.prototype.onLoaded = function (s) {
        ...
        if (!Common.IS_NATIVE_APP) {
            ...
            if (Common.APP_NATIVE_DATA.force == "1") {
                this.temp_token = "";
                SaveManager.getObj().save(SaveManager.KEY_TOKEN, "");
            }
            var urlJson = Common.APP_NATIVE_DATA.urlJSON;
    ...
    LoadingScene.prototype.requestTokenTest = function (token) {
        var url = ConfObjRead.getConfUrl().url.accounturl +
