...
var NoticeBtnsPage = /** @class */ (function (_super) {
    ...
    //修改当前索引页面
    NoticeBtnsPage.prototype.changeTab = function (noticeid) {
        // Debug.trace("NoticeBtnsPage.changeTab:"+noticeid);
        this.curShowId = noticeid;
        this.updateTab();
    };
    ...
    //设置对应按钮已读
    NoticeBtnsPage.prototype.setReaded = function (noticeId) {
        for (var c = 0; c < this.arr_btns.length; c++) {
            var d = this.arr_btns[c];
